<template>
	<div slot="dice" class="dice-wrapper">
		<el-alert class="dice-title" type="info" center :closable="false" show-icon>
			<div slot="title">
				<h2 class="s-c">
		...
		>
			...
			<el-form-item label="单元类型" prop="type" class="custom-item bs">
				<el-select
			...
			<el-form-item label="像素颜色" prop="unitColor" class="custom-item bs">
				<el-color-picker v-model="ruleForm.unitColor" size="mini"></el-color-picker>
			</el-form-item>
			<el-form-item label="背景颜色" prop="bgColor" class="custom-item bs">
				...
				>
					...
					>
						...
						<div slot="file" slot-scope="{file}">
							<img class="el-upload-list__item-thumbnail" ref="thumbnail" :src="file.url" alt="" />
							<span class="el-upload-list__item-actions">
								...
								<span class="el-upload-list__item-delete" @click="rawFileList = []">
...
export default {
	...
	beforeRouteEnter(to, from, next) {
		next(
			(vm) => (
				vm.$store.commit('EDIT_METANAME', to.meta), vm.$store.commit('EDIT_MENUINDEX', '2-1')
			)
		);
	},
	data() {
