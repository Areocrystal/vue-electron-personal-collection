    ...
    <div class="date-wrapper">
        <el-dropdown trigger="click" @command="commandHandler">
            <span class="el-dropdown-link">
                {{showGap?'日期之间的相隔时间':'添加或减去天数'}}<i class="el-icon-arrow-down el-icon--right"></i>
            </span>
        ...
        <div v-show="showGap" style="padding-top: 24px;">
            <el-row class="row-p">
                ...
                <el-col :span="24" class="col-p s-c">
                    <span class="s-c" style="margin-right: 7px;">{{startDate|date-format('yyyy年MM月dd日')}}</span>
                    <el-link :underline="false">
                        <i v-if="hideStart" class="el-icon-date" @click="hideStart = false"></i>
                        <el-date-picker v-else :clearable="false" style="width:50px"
                                        v-model="startDate"
                                        type="date" size="mini"
                                        placeholder="选择日期时间" @change="hideStart = true">
                        </el-date-picker>
                    </el-link>
                </el-col>
            </el-row>
            <el-row class="row-p">
                ...
                <el-col :span="24" class="col-p s-c">
                    <span class="s-c" style="margin-right: 7px;">{{endDate|date-format('yyyy年MM月dd日')}}</span>
                    <el-link :underline="false">
                        <i v-if="hideEnd" class="el-icon-date" @click="hideEnd = false"></i>
                        <el-date-picker v-else :clearable="false" style="width:50px"
                                        v-model="endDate"
                                        type="date" size="mini"
                                        placeholder="选择日期时间" @change="hideEnd = true">
                        </el-date-picker>
                    </el-link>
                </el-col>
            </el-row>
        ...
        <div v-show="!showGap">
            <el-row class="row-p">
                ...
                <el-col :span="24" class="col-p s-c">
                    <span class="s-c" style="margin-right: 7px;">{{startDate2|date-format('yyyy年MM月dd日')}}</span>
                    <el-link :underline="false">
                        <i v-if="hideStart" class="el-icon-date" @click="hideStart = false"></i>
                        <el-date-picker v-else :clearable="false" style="width:50px"
                                        v-model="startDate2"
