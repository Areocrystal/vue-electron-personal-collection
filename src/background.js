...
const template = [
  ...
  }] : []),
  {
    label: '编辑(edit)',
    submenu: [
      {label: '撤销(undo)', role: 'undo'},
      {label: '重做(redo)', role: 'redo'},
      {type: 'separator'},
      {label: '剪切(cut)', role: 'cut'},
      {label: '复制(copy)', role: 'copy'},
      {label: '粘贴(paste)', role: 'paste'},
      ...(isMac ? [
        {role: 'pasteAndMatchStyle'},
        {label: '删除(delete)', role: 'delete'},
        {label: '选择全部(selectAll)', role: 'selectAll'},
        {type: 'separator'},
        {
          label: 'Speech',
          submenu: [
  ...
  // { role: 'viewMenu' }
  {
    ...
    submenu: [
      ...
      // },
      {type: 'separator'},
      {label: '切换全屏(togglefullscreen)', role: 'togglefullscreen'},
    ]
  },
  {
    label: '窗口(screen)',
    submenu: [{label: '重置窗口(resetzoom)', role: 'resetzoom'},
      {label: '放大窗口(zoomin)', role: 'zoomin'},
      {label: '缩小窗口(zoomout)', role: 'zoomout'}, {type: 'separator'}, {
        label: '最小化(Minimize)',
