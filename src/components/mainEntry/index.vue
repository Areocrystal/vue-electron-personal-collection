    ...
    <baseLayout>
        <div slot="mainEntry" class="main-wrapper">
            ...
            <el-row class="famous-row">
                <el-col :span="24">
                    <vue-transform-effect v-show="showEffect"
                                          style="width: 60%;height: 120px;z-index: 0;"
                                          :baseSize="10"></vue-transform-effect>
                    <el-card shadow="hover">
                        <p>
                            <font-awesome-icon icon="book" class="icon"/>&nbsp;<span
                                class="famous-text">{{displayText}}</span>
                        </p>
                        <div class="card-b">
                            <span style="text-align: left">
                                <font-awesome-icon icon="tags" class="icon" style="font-size:24px;"/>
                            </span>
                            <el-button type="primary" round @click.stop="$store.commit('famous/DEL_ONE', displayText)"
                                       size="mini" class="f-btn">下一条言语
                            </el-button>
                        </div>
                    </el-card>
                </el-col>
